...
import Web1 from '../../../../assets/Home/Categories/Web1.png'
import Web2 from '../../../../assets/Home/Categories/Web2.png'
import Web3 from '../../../../assets/Home/Categories/Web3.png'
import Next from '../../../../assets/Home/Categories/Next.svg'
export const Cat=[
    {
...
export const  PopularCourses =[
    {
        ...
        text: 'Javascript for Beginnners',
        icon:Next
    ...
    },
    {
        ...
        img:Web2,
        title:'Web Development',
        text:'Angular - The Complete Guide ',
        icon:Next
    },
    {
        to:'/',
        img:Web3,
        title:'Web Development',
        text:'Real - World Webside with HTML and CSS',
        icon:Next
    }
]